<template>
	<view class="container p-16 b-b">
		<view class="column m-b-10" v-for="(item,i) in orderList" :key="i">
			<view class="b-r-15 b-F9F j-center b-b m-b-10" style="padding: 20rpx;">
				...
				<view class="flex_1 column f-between m-l-10">
					...
					<view class="f-between j-center">
						...
						<!-- <view class="f-w-600 b-b b-1A8 c-w b-r-5" style="padding: 10rpx;">售后申请</view> -->
					</view>
				</view>
			</view>
			<view class="b-r-15 b-F9F b-b column content" style="padding: 40rpx 32rpx 0;">
				<view class="flex_1 f-between m-b-20" v-for="(item1,index) in dataList" :key="index">
					...
					<text v-if="index == 3" selectable="true" @tap="copy(i)">{{item.sn}}</text>
				</view>
			</view>
		</view>
